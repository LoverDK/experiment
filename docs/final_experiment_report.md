...
- 语义失配从 0 增至 0.25 时，ATLAS 接受率从 0.5150 降至 0.3000，接受样本 MAE 从 0.1115 升至 0.1364。
- 每实验样本量从 100 增至 1000 时，接受率从 0.2500 升至 0.6050。
...
| --- | ---: | ---: | ---: | ---: |
| atlas | 0.4567 | 0.1111 | 0.1380 | 1.0000 |
| atlas_no_rejection | 1.0000 | 0.1388 | 0.1705 | 1.0000 |
...
完整 ATLAS 的名义接受样本 MAE 为 0.1111，低于 no-rejection 的 0.1388。
在语义失配 0.25 下，ATLAS 接受率降至 0.2767；隐藏半径 0.40 时接受率为 0.0000。这些结果说明拒绝集中发生在
证书较大的困难目标上。
...
- 低报平滑界也发布全部点，但覆盖降至 0.8767。

在严重语义失配下，低报平滑界的覆盖进一步降至 0.7533，而 no-rejection 有 0.9933 的发布点超过容忍度。
