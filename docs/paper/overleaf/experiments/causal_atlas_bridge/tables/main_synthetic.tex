...
ATLAS release: Wilson 95\% interval $[0.408,0.520]$; released-target MAE: Monte Carlo SE $0.007$. Paired all-target error differences are reported in Table~\ref{tab:v1-app-paired-comparison}.
\par
