# Stage 9：失败组合后的部分识别实验

## 理论目标

本阶段对应论文 Definition 5.1 和 Theorem 5.4。点组合因证书超过科学容忍度而
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| nominal | 0.5167 | 1.0000 | 1.0000 | 1.0000 | 3.6462 | 3.7501 | 0.0271 | 0.0000 |
| mismatch 0.25 | 0.7800 | 1.0000 | 1.0000 | 1.0000 | 4.0905 | 4.3373 | 0.0511 | 0.1325 |
| mismatch 0.60 | 0.9733 | 1.0000 | 1.0000 | 1.0000 | 5.6745 | 6.4838 | 0.1142 | 0.6471 |
| mismatch 0.80 | 0.9900 | 1.0000 | 1.0000 | 1.0000 | 7.0770 | 8.0676 | 0.1124 | 0.9974 |
...
本阶段没有证明 minimax 最优性，也没有运行 bridge experiment。oracle 凸包距离
